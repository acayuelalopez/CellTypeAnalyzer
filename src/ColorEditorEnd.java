...
public class ColorEditorEnd extends AbstractCellEditor implements TableCellEditor {
	private JPanel myPanel, panelAdd;
	private int input;
	...
	private Color currentColorAdd, currentColorEdit, colorCInitial;
	private Object labelC, colorC;
	private String addTextInitial, addTextFinal;
	...
	public void comboClassAction() {
		...
		for (int i = 0; i < MiddlePageModified.tablePositive.getRowCount(); i++) {
			ch2Initial.add(((JLabel) MiddlePageModified.tablePositive.getValueAt(i, 2)).getText());
			ch3Initial.add(((JLabel) EndPageModified.tablePositive.getValueAt(i, 2)).getText());
		}
