...
public class MiddlePageModified2 extends AbstractWizardPage {
	...
	public MiddlePageModified2() {
		...
		frame.setTitle("Cell-Type Viewer");
		...
		comboChDomain.addItem("Marker II");
		comboChDomain.addItem("Marker III");
		...
		comboChRange.addItem("Marker II");
		comboChRange.addItem("Marker III");
		...
		comboClass.setToolTipText("Select a cell-type to be analyzed.");
		...
		regreOrderPanel.add(filterOrder);
		JPanel filterOrderPanel = new JPanel(new FlowLayout(FlowLayout.LEFT));
		filterOrderPanel.add(new JLabel("Select a Cell-Type: "));
		...
		chartDomainPanelBox.add(filterOrderPanel);
		...
		JLabel labelTablePositive = new JLabel(" Cell-Type Classification: ");
		...
		labelPositive.setText(" Cell-Type Counter both Makers:  ");
		labelPositive.setFont(new Font(Font.DIALOG, Font.BOLD, 12));
		labelClass.setText(" Cell-Type Counter per Marker:  ");
		labelClass.setFont(new Font(Font.DIALOG, Font.BOLD, 12));
		labelQuadrant.setText(" Quadrant Counter:  ");
	...
	public void buildTable() {
		...
		String[] columnHeaders = new String[] { "Single Cell", "ID", labelCh2, labelCh3, "Cell-Type" };
